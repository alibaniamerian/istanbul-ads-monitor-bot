...
async def analyze_listing(
    ...
    prompt = """این متن و تصاویر یک پیام از گروه تلگرامی ایرانیان استانبول هستند.
اول تشخیص بده پیام آگهی فروش است یا گفت‌وگوی معمولی، سؤال، پاسخ یا مذاکره. فقط JSON معتبر برگردان و هیچ متن دیگری ننویس.
بین آگهی واقعی و گفت‌وگوی معمولی، سؤال، پاسخ به فروشنده یا مذاکره تشخیص بده.
اگر متن فقط مذاکره یا گفت‌وگوی عادی است و محصول جدیدی برای فروش معرفی نمی‌کند، is_ad را false کن.
